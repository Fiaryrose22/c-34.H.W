...
function setup() 
{
  ...
  //btn 2
   ...
   button2.position(50,550);
   button2.size(50,50);
   button2.mouseClicked(drop2);
 
   rope = new Rope(4,{x:120,y:90});
   rope2 = new Rope(6,{x:50,y:550});

   star = createSprite(50,370,20,20)
   star.addImage(starimg)
   star.scale=0.02

   star2 = createSprite(100,50,20,20)
  ...
  ground = new Ground(250,150,100,10);
  blink.frameDelay = 20;
  eat.frameDelay = 20;
...
function draw() 
{
  ...
  if(collide(fruit,bunny,20)==true)
  {
